export const id = {
  ...
  footer: {
    ...
    officialLinks: {
      ...
      admisi: "Admisi",
      biayaKuliah: "Biaya Kuliah",
      faq: "FAQ",
      karir: "Karir",
      versimu: "Kampus Virtual (VersiMu)",
    },
    campusTitle: "Kampus Pusat",
    addressLine1: "Jalan HOS Cokroaminoto No. 17 RT 53 RW 12, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55253",
    addressLine2: "",
    upbjjKuningan: "",
    upbjjKendari: "",
    operationalPermit: "Izin Operasional: Keputusan Mendikbudristek No 430/E/O/2021",
    accreditation: "Akreditasi: BAIK",
    contactTitle: "Kontak",
    contactEmailLabel: "Email:",
    contactPhoneLabel: "Telepon Kampus Pusat:",
    contactWaLabel: "WhatsApp Penmaru (Pendaftaran):",
    creditsTitle: "Kredit Halaman",
    credits: {
