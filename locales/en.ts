export const en = {
  ...
  megaMenu: {
    kemahasiswaan: {
      item1: "Student Organizations & Student Activity Units (UKM)",
      item2: "Achievements",
      item3: "Services",
    ...
    aik: {
      item1: "Religious Activities, Study Sessions & Da'wah",
      item2: "Core Values of Muhammadiyah",
      promoTitle: "GROW & SERVE",
      promoHeading: "Knowledge Rooted in Islamic Values",
      promoCta: "Explore",
    },
  },
  section2: {
  ...
  footer: {
    ...
    officialLinks: {
      ...
      admisi: "Admissions",
      biayaKuliah: "Tuition Fees",
      faq: "FAQ",
      karir: "Careers",
      versimu: "Virtual Campus (VersiMu)",
    },
    campusTitle: "Main Campus",
    addressLine1: "Jalan HOS Cokroaminoto No. 17 RT 53 RW 12, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55253",
    addressLine2: "",
    upbjjKuningan: "",
    upbjjKendari: "",
    operationalPermit: "Operational Permit: Decree of Mendikbudristek No 430/E/O/2021",
    accreditation: "Accreditation: BAIK",
    contactTitle: "Contact",
    contactEmailLabel: "Email:",
    contactPhoneLabel: "Main Campus Phone:",
    contactWaLabel: "WhatsApp Bureau of Student Affairs and AIK:",
    creditsTitle: "Page Credits",
    credits: {
      icons: "Icons — Inline SVG (custom)",
      fontsFull: "Fonts — System UI",
      heroAnimFull: "Hero Animation — Google Flow (Nano Banana 2, AI video generation)",
      illustrationsFull: "Student Affairs & AIK Illustrations — Google Gemini (AI image generation)",
      achievements: "Achievement & Syiar Thumbnails — Official articles & press coverage",
      videoThumbnails: "Kajian Video Thumbnails — YouTube",
      referencesFull: "Links & Reference Data — SIBERMU Official Website",
    },
